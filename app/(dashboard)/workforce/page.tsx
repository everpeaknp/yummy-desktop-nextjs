...
export default function WorkforcePage() {
  ...
  const load = useCallback(async () => {
    setLoading(true);
    const [staffResult, overviewResult, entriesResult, balancesResult] = await Promise.allSettled([
        ...
        <div className="grid gap-5 lg:grid-cols-[minmax(0,1.35fr)_minmax(320px,0.65fr)]">
          <Card>
            ...
            <CardContent className="space-y-3">
              ...
              {!attendanceReview.length && totalToPay <= 0 ? <ReadyRow text="No outstanding salary is waiting to be paid." /> : null}
            </CardContent>
          </Card>
