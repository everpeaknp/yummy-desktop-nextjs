...
const MANAGE_ITEMS = [
    ...
    { title: "Receipt Designer", href: "/manage/additional-settings?setting=receipt_designer", icon: Receipt, section: "Additional Settings / Hardware" },
    { title: "KOT Designer", href: "/manage/additional-settings?setting=kot_designer", icon: FileEdit, section: "Additional Settings / Hardware" },
...
export function GlobalSearch({ open, onOpenChange }: GlobalSearchProps) {
    ...
    const allItems = useMemo(() => {
        ...
        // Add Manage Items (will overwrite/merge if already exists)
