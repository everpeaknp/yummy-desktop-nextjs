...
import { 
    ...
    Banknote, BookOpenCheck, BadgeDollarSign
} from "lucide-react";
...
const MANAGE_ITEMS = [
    ...
    { title: "Menu options & add-ons", href: "/menu/modifiers", icon: Settings2, section: "Manage / Menu & Offers" },
    { title: "Discounts", href: "/discounts", icon: Percent, section: "Manage / Menu & Offers" },
    { title: "Cash & Banks", href: "/finance/operations", icon: Banknote, section: "Manage / Finance & Insights" },
    { title: "Sales", href: "/finance/sales", icon: Receipt, section: "Finance" },
    { title: "Purchases", href: "/inventory/purchases", icon: ShoppingCart, section: "Finance" },
    { title: "Other Income", href: "/finance/other-income", icon: TrendingUp, section: "Finance" },
    { title: "Expenses", href: "/finance/expenses", icon: TrendingDown, section: "Manage / Finance & Insights" },
    { title: "Payments", href: "/finance/payments", icon: BadgeDollarSign, section: "Finance" },
    { title: "Journal Vouchers", href: "/finance/journals", icon: BookOpenCheck, section: "Finance" },
    { title: "Analytics", href: "/analytics", icon: LineChart, section: "Manage / Finance & Insights" },
    { title: "Finance Setup", href: "/finance/setup", icon: Settings, section: "Finance" },
    ...
    { title: "Suppliers", href: "/suppliers", icon: Truck, section: "Purchasing" },
    { title: "Purchase documents", href: "/inventory/purchases", icon: ShoppingCart, section: "Purchasing" },
