...
export function FilterBar({
  ...
  return (
    <div className={cn("min-w-0", className)} {...props}>
      <div
        className={cn(
          "hidden min-h-11 min-w-0 flex-wrap items-center gap-2",
          responsiveAt === "lg" ? "lg:flex" : "md:flex",
        )}
      >
      ...
      <div
        className={cn(
          ...
          responsiveAt === "lg" ? "lg:hidden" : "md:hidden",
        )}
      >
        ...
        <Sheet>
          <SheetTrigger asChild>
            ...
            >
              <span
                className={cn(
                  "flex items-center gap-2",
                  mobileTriggerVariant === "icon" && "sr-only",
                )}
              >
          ...
          <SheetContent
            side="bottom"
            className="max-h-[88dvh] overflow-hidden rounded-t-3xl p-0"
          >
