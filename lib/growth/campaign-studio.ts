...
export const CAMPAIGN_PLAYBOOKS: readonly CampaignPlaybookDefinition[] = [
  {
    ...
    description: "Bring back first-time customers who visited once but haven't returned yet.",
  ...
  },
  {
    ...
    shortTitle: "Win Back",
    description: "Invite loyal customers who used to visit regularly but haven't been back recently (45+ days).",
  ...
  },
  {
    ...
    shortTitle: "Slow Day",
    description: "Fill quiet hours by inviting your active regular customers during slow periods.",
